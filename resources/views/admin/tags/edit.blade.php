...
<div class="mb-6 flex items-center gap-3">
    <a href="{{ route('admin.tags.index') }}" class="text-gray-400 hover:text-gray-600">
        <i class="fas fa-arrow-left text-lg"></i>
    </a>
    <h2 class="text-xl font-bold text-gray-800">
        <i class="fas fa-tag text-red-500 mr-2"></i>Edit Tag
    </h2>
</div>
        ...
        <form method="POST" action="{{ route('admin.tags.update', $tag) }}" class="space-y-5">
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">
                    <i class="fas fa-hashtag text-gray-400 mr-1"></i>Nama Tag <span class="text-red-500">*</span>
                </label>
                ...
                <p class="text-xs text-gray-400 mt-1">
                    Slug saat ini: <code class="bg-gray-100 px-1.5 py-0.5 rounded text-gray-600">{{ $tag->slug }}</code>
                </p>
            </div>
